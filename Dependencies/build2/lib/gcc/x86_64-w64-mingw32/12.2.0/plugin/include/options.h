...
enum opt_code
{
  ...
  OPT_malign_vector_insn = 1789,             /* -malign-vector-insn */
  ...
  OPT_mconsole = 1829,                       /* -mconsole */
  /* OPT_mcpu_ = 1830, */                    /* -mcpu= */
  OPT_mcrc32 = 1831,                         /* -mcrc32 */
  OPT_mcrtdll_ = 1832,                       /* -mcrtdll= */
  OPT_mcx16 = 1833,                          /* -mcx16 */
  OPT_mdirect_extern_access = 1834,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1835,            /* -mdispatch-scheduler */
  OPT_mdll = 1836,                           /* -mdll */
  OPT_mdump_tune_features = 1837,            /* -mdump-tune-features */
  OPT_menqcmd = 1838,                        /* -menqcmd */
  OPT_mf16c = 1839,                          /* -mf16c */
  OPT_mfancy_math_387 = 1840,                /* -mfancy-math-387 */
  OPT_mfentry = 1841,                        /* -mfentry */
  OPT_mfentry_name_ = 1842,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1843,               /* -mfentry-section= */
  OPT_mfma = 1844,                           /* -mfma */
  OPT_mfma4 = 1845,                          /* -mfma4 */
  OPT_mforce_drap = 1846,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1847,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1848,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1849,                       /* -mfpmath= */
  OPT_mfsgsbase = 1850,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1851,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1852, */              /* -mfused-madd */
  OPT_mfxsr = 1853,                          /* -mfxsr */
  ...
  OPT_mno_align_vector_insn = 1892,          /* -mno-align-vector-insn */
  OPT_mno_default = 1893,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1894,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1895,                  /* -mno-push-args */
  OPT_mno_red_zone = 1896,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1897,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1898,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1899,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1900,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1901,                          /* -mpc32 */
  OPT_mpc64 = 1902,                          /* -mpc64 */
  OPT_mpc80 = 1903,                          /* -mpc80 */
  OPT_mpclmul = 1904,                        /* -mpclmul */
  OPT_mpcommit = 1905,                       /* -mpcommit */
  OPT_mpconfig = 1906,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1907,            /* -mpe-aligned-commons */
  OPT_mpku = 1908,                           /* -mpku */
