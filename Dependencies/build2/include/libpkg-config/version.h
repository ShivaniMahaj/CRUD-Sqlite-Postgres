 ...
 */
#define LIBPKG_CONFIG_VERSION       1000010000ULL
#define LIBPKG_CONFIG_VERSION_STR   "0.1.1"
#define LIBPKG_CONFIG_VERSION_ID    "0.1.1"
#define LIBPKG_CONFIG_VERSION_FULL  "0.1.1"

#define LIBPKG_CONFIG_VERSION_MAJOR 0
#define LIBPKG_CONFIG_VERSION_MINOR 1
#define LIBPKG_CONFIG_VERSION_PATCH 1
