/* Generated automatically by the program 'C:\temp\mingw-w64-gcc\src\build-MINGW64\gcc\build\genpreds.exe'
   from the machine description file '../../gcc-12.2.0/gcc/config/i386/i386.md'.  */
