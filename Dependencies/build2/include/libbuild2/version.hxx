...
#define LIBBUILD2_VERSION       16000000000ULL
#define LIBBUILD2_VERSION_STR   "0.16.0"
#define LIBBUILD2_VERSION_ID    "0.16.0"
#define LIBBUILD2_VERSION_FULL  "0.16.0"

#define LIBBUILD2_VERSION_MAJOR 0
#define LIBBUILD2_VERSION_MINOR 16
...
#  if !(LIBBUTL_VERSION >= 16000000000ULL && LIBBUTL_VERSION < 16999990001ULL)
#    error incompatible libbutl version, libbutl ^0.16.0 is required
#  endif
#endif
